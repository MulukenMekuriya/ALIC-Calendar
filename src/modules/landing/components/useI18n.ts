...
const I18N = {
  en: {
    ...
    'footer.tag': 'A community of believers gathering in Silver Spring and Alexandria — to worship Jesus, grow together, and carry the gospel forward.',
    ...
    'hero.lede': 'Two campuses. One family. Worshipping in Amharic since 2008.',
  ...
  am: {
    ...
    'cta.give': 'ይዋጡ',
    'cta.plan': 'ጉብኝትዎን ያቅዱ',
    'footer.tag': 'የኢየሱስ ክርስቶስን ወንጌል የምታውጅ እና ቁርጥ ያሉ ደቀመዛሙርትን የምታሳድግ ቤተክርስቲያን እናያለን።',
...
export function useI18n() {
  const [lang, setLangState] = useState<Lang>(() => {
    try { return (localStorage.getItem('alic.lang') as Lang) || 'en'; } catch { return 'en'; }
  });

  useEffect(() => {
    try { localStorage.setItem('alic.lang', lang); } catch {}
