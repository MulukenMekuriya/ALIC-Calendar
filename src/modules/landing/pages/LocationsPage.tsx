...
const CAMPUSES = [
  {
    ...
    addr: "8818 Piney Branch Rd", city: "Silver Spring, MD 20903",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=8818+Piney+Branch+Rd+Silver+Spring+MD+20903",
    mapsEmbed: "https://www.google.com/maps?q=8818+Piney+Branch+Rd+Silver+Spring+MD+20903&output=embed",
    pastor: "Pastor Elias Getaneh", role: "Lead Pastor",
    yt: "https://www.youtube.com/@addislidetmedia",
    fb: "https://www.facebook.com/AddisLedet/",
    tagline: "Where the family first gathered.",
    since: "Since 2009",
    rhythm: [
      { day: "Sunday",    items: [["Morning Prayer","10:00a"],["Sunday Worship","11:00a"],["Young Adult","6:30p"]] },
      { day: "Wednesday", items: [["Midweek Service","6:30p"]] },
      { day: "Thursday",  items: [["Thursday Prayer","10:00a"]] },
      { day: "Friday",    items: [["Overnight Prayer","8:30p"]] },
    ],
  },
  {
    ...
    pastor: "Pastor Beneyam", role: "Lead Pastor",
    ...
    since: "Since 2017 · New home 2026",
    rhythm: [
      { day: "Sunday",   items: [["Morning Prayer","9:30a"],["Sunday Worship","10:30a"]] },
      { day: "Tuesday",  items: [["Bible Study","7:00p"]] },
      { day: "Friday",   items: [["Prayer Night","7:00p"]] },
      { day: "Saturday", items: [["Young Adults","7:00p"]] },
    ],
  },
];
